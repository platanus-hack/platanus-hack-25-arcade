...
function createAllSprites(scene) {
  ...
  // Banana realista
  drawTex("banana32", 36, 24, (ctx, w, h) => {
    ctx.save();
    const mainGrad = ctx.createLinearGradient(8, 4, 28, 20);
    mainGrad.addColorStop(0, "#FFF176");
    mainGrad.addColorStop(0.3, "#FFD54F");
    mainGrad.addColorStop(0.7, "#FFC107");
    mainGrad.addColorStop(1, "#FFB300");
    ctx.fillStyle = mainGrad;
    ctx.beginPath();
    ctx.moveTo(8, 16);
    ctx.bezierCurveTo(10, 6, 18, 4, 26, 6);
    ctx.bezierCurveTo(30, 7, 31, 10, 29, 14);
    ctx.bezierCurveTo(26, 19, 16, 22, 10, 19);
    ctx.bezierCurveTo(7, 18, 7, 17, 8, 16);
    ctx.closePath();
    ctx.fill();
    // Sombra
    const shadowGrad = ctx.createLinearGradient(10, 10, 14, 20);
    shadowGrad.addColorStop(0, "rgba(255, 160, 0, 0)");
    shadowGrad.addColorStop(1, "rgba(184, 134, 11, 0.3)");
    ctx.fillStyle = shadowGrad;
    ctx.beginPath();
    ctx.moveTo(9, 17);
    ctx.quadraticCurveTo(11, 20, 13, 19);
    ctx.quadraticCurveTo(16, 19, 18, 18);
    ctx.quadraticCurveTo(12, 16, 9, 17);
    ctx.fill();
    // Brillo
    const highlightGrad = ctx.createRadialGradient(20, 9, 1, 20, 9, 6);
    highlightGrad.addColorStop(0, "rgba(255, 255, 255, 0.6)");
    highlightGrad.addColorStop(1, "rgba(255, 255, 255, 0)");
    ctx.fillStyle = highlightGrad;
    ctx.beginPath();
    ctx.ellipse(20, 9, 6, 3, -0.3, 0, Math.PI * 2);
    ctx.fill();
    // Manchas marrones
    ctx.fillStyle = "rgba(101, 67, 33, 0.4)";
    ctx.beginPath();
    ctx.ellipse(15, 12, 2, 1, 0.5, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(22, 14, 1.5, 0.8, -0.3, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(12, 17, 1.2, 0.6, 0.8, 0, Math.PI * 2);
    ctx.fill();
    // Contorno
    ...
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(27, 6, 1.5, 2, -0.5, 0, Math.PI * 2);
    ctx.fill();
    ctx.restore();
  });
